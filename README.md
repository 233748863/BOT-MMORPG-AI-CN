...
| 技能 | 9-19 | 1, 2, 3, 4, 5, 6, Q, E, R, G, C |
| 特殊 | 20-22 | 空格(跳跃/闪避), Tab(切换目标), F(交互) |
| 鼠标 | 23-27 | 左键, 右键, 中键, 滚轮上, 滚轮下 |
| Shift组合 | 28-32 | Shift+1, Shift+2, Shift+Q, Shift+E, Shift+R |
| Ctrl组合 | 33-35 | Ctrl+1, Ctrl+2, Ctrl+Q |
