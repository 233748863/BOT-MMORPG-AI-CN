...
def inception_v3(宽度, 高度, 帧数, 学习率, 输出类别=9, 模型名称='游戏AI模型'):
    ...
    """
    # 输入层
    network = input_data(shape=[None, 宽度, 高度, 3], name='input')
...
# 中文别名
创建Inception模型 = inception_v3


if __name__ == "__main__":
    print("模型定义模块")
    print("可用模型: inception_v3 (Inception V3)")
    print("\n使用示例:")
    print("  model = inception_v3(480, 270, 3, 1e-3, 输出类别=9)")
