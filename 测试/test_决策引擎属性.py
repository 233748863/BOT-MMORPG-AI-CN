    ...
    **Validates: Requirements 3.1, 3.2, 3.3, 3.4**
    ...
    def test_战斗状态技能权重较高(self):
        ...
        **Validates: Requirements 3.2**
        ...
        # 获取技能动作的权重 (动作9-18是技能)
        技能权重 = [战斗权重[i] for i in range(9, 19) if i < len(战斗权重)]
        # 获取移动动作的权重 (动作0-8是移动)
    ...
    def test_对话状态交互权重较高(self):
        ...
        **Validates: Requirements 3.3**
        ...
        # 获取鼠标动作的权重 (动作22-24是鼠标)
        鼠标权重 = [对话权重[i] for i in range(22, 25) if i < len(对话权重)]
        # 获取技能动作的权重 (动作9-18是技能)
        技能权重 = [对话权重[i] for i in range(9, 19) if i < len(对话权重)]
    ...
    def test_移动状态移动权重较高(self):
        ...
        **Validates: Requirements 3.4**
        ...
        # 获取技能动作的权重 (动作9-18是技能)
        技能权重 = [移动状态权重[i] for i in range(9, 19) if i < len(移动状态权重)]
