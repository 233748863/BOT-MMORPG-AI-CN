...
动作定义 = {
    ...
    18: {"名称": "技能G", "按键": "G", "类型": "技能"},
    19: {"名称": "技能C", "按键": "C", "类型": "技能"},
    
    # 特殊动作 (20-22)
    20: {"名称": "跳跃/闪避", "按键": "空格", "类型": "特殊"},
    21: {"名称": "切换目标", "按键": "Tab", "类型": "特殊"},
    22: {"名称": "交互", "按键": "F", "类型": "特殊"},
    
    # 鼠标动作 (23-27)
    23: {"名称": "鼠标左键", "按键": "鼠标左", "类型": "鼠标"},
    24: {"名称": "鼠标右键", "按键": "鼠标右", "类型": "鼠标"},
    25: {"名称": "鼠标中键", "按键": "鼠标中", "类型": "鼠标"},
    26: {"名称": "滚轮向上", "按键": "滚轮上", "类型": "鼠标"},
    27: {"名称": "滚轮向下", "按键": "滚轮下", "类型": "鼠标"},
    
    # Shift组合技能 (28-32)
    28: {"名称": "Shift+1", "按键": "Shift+1", "类型": "组合"},
    29: {"名称": "Shift+2", "按键": "Shift+2", "类型": "组合"},
    30: {"名称": "Shift+Q", "按键": "Shift+Q", "类型": "组合"},
    31: {"名称": "Shift+E", "按键": "Shift+E", "类型": "组合"},
    32: {"名称": "Shift+R", "按键": "Shift+R", "类型": "组合"},
    
    # Ctrl组合技能 (33-35)
    33: {"名称": "Ctrl+1", "按键": "Ctrl+1", "类型": "组合"},
    34: {"名称": "Ctrl+2", "按键": "Ctrl+2", "类型": "组合"},
    35: {"名称": "Ctrl+Q", "按键": "Ctrl+Q", "类型": "组合"},
}
...
class 训练模式:
    ...
    主线任务 = {
        "名称": "主线任务练级",
        "描述": "学习做主线任务的操作习惯",
        "启用动作": list(range(9)) + [21, 22, 23],  # 移动 + 切换目标/交互 + 鼠标左键
        "动作权重": [
            # 移动 (高权重)
    ...
    自动战斗 = {
        "名称": "自动战斗",
        "描述": "学习战斗技能释放和走位",
        "启用动作": list(range(总动作数)),  # 全部动作
        "动作权重": [
            # 移动 (中等权重)
            2.0, 0.5, 1.0, 1.0, 1.5, 1.5, 0.5, 0.5, 0.1,
            # 技能 (高权重)
            2.0, 2.0, 2.0, 2.0, 1.5, 1.5, 2.0, 2.0, 1.5, 1.5, 1.5,
            # 特殊 (高权重)
            2.0, 1.5, 1.0,
            # 鼠标 (高权重)
            2.5, 2.0, 0.5, 0.5, 0.5,
...
按键码 = {
    ...
    "Q": 0x10, "E": 0x12, "R": 0x13, "F": 0x21, "G": 0x22, "C": 0x2E,
